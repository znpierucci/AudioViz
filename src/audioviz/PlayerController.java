...
public class PlayerController implements Initializable {
    ...
    private void handleReady() {
        ...
        String length = String.format("%.1f", duration.toMillis()) + " ms";
        lengthText.setText(length);
        Duration currentTime = mediaPlayer.getCurrentTime();
        String current = String.format("%.1f", currentTime.toMillis()) + " ms";
    ...
    @FXML
    public void handleSliderTouched(Event event) {
        if (mediaPlayer != null) {
            mediaPlayer.pause();
        }
    }
    ...
    @FXML
    public void handleSliderUnTouched(Event event) {
        if (mediaPlayer != null) {
            Duration duration = new Duration(timeSlider.getValue()); 
